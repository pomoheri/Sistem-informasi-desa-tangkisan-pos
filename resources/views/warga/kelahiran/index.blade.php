...
@section('ribbon')
    <div class="content-header">
        <h4 class="content-title">Kelahiran</h4>
        <div class="content-breadcrumb ms-auto">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('home') }}">Beranda</a></li>
                <li class="breadcrumb-item active" aria-current="page">Permohonan Kelahiran</li>
            </ol>
        </div>
    </div>
@endsection
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 text-center">
                                <h4 class="content-title mt-0 pt-0 text-muted">Data Permohonan Kelahiran</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <table id="dt_basic" class="table table-sm table-striped table-bordered table-hover dataTable" aria-describedby="datatables_info" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center align-middle">Nama Bayi</th>
                                                <th class="text-center align-middle">Tgl Lahir Bayi</th>
                                                <th class="text-center align-middle">Tempat Lahir Bayi</th>
                                                <th class="text-center align-middle">Jenis Kelamin</th>
                                                <th class="text-center align-middle">Penolong</th>
                                        ...
                                        <tbody>
                                            @forelse ($list as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ $item->penolong }}</td>
                                                    <td>{{ ($item->surat_lahir) ? 'Surat Telah Selesai Dibuat' : 'Proses Permohonan' }}</td>
                                                    <td class="text-center">
                                                        @if($item->surat_lahir)
                                                            <a title="Surat-Kelahiran" download="Surat-Kelahiran" href="{{ Storage::url($item->surat_lahir) }}" class="btn btn-sm btn-success"><i class="ri-mail-download-fill"></i> Donwload Surat</a>
                                                        @else
                                                            <button class="btn btn-sm btn-warning" data-item="{{ $item }}" onclick="editPenduduk(this)"><i class="ri-edit-2-line"></i></button>
                                                            <a href="{{ route('warga.kelahiran.delete',[$item]) }}" class="btn btn-sm btn-danger delete"><i class="ri-delete-bin-line"></i></a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            @empty
